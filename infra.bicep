...
param environment_name string = 'env-unicorn-dev'
param location string = resourceGroup().location
//param storageAccountName string = 'storage${replace(uniqueSuffix, '-', '')}'
param storageAccountName string = 'storageunicorndev'
param blobContainerName string = 'blob-unicorn-blob'
param managedIdentityName string = 'nodeapp-identity'
var logAnalyticsWorkspaceName = 'logs-${environment_name}'
var appInsightsName = 'appins-${environment_name}'

@secure()
param dockerhubHandle string
      ...
      containers: [
        {
          ...
          //name: 'hello-k8s-node'
          image: 'registry.hub.docker.com/royerm/unicorn-frontend:latest'
